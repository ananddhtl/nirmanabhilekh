...
<section class="content-header">
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-6 ">
                        ...
                        <form action="{{url('/expensessearch')}}" method="GET" accept-charset="utf-8">
                            @csrf
                ...
                <table class="table table-bordered" id="mytable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a style="width:40px" href="{{url('edit-fromexpensesequipment/'.$item->id)}}" class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a>&nbsp;
    ...
    <script>
        function showModal(id) {
            document.getElementById("deleteItem").href = "/delete-equipmentexpenses/" + id;
