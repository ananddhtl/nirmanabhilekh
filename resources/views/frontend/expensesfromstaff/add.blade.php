...
<div class="col-md-6">
    ...
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title">Add staff expense </h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        @if($errors->any())
        ...
        @endif
        <form action="{{route('addexpensesstaff')}}" method="POST">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" class="form-control" autocomplete="off" name="StaffName" onkeyup="searchStaff();" id="StaffName" placeholder="Enter Staff Name" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" autocomplete="off" name="narration" id="narration" placeholder="Enter Remarks" required>
                    </div>
                </div>
