...
<div class="col-md-12">
  ...
  <div class="card card-info">
    <div class="card-header">
      <h3 class="card-title">Service billing </h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    @if($errors->any())
    ...
    @endif
    <form action="{{route('postServiceBillItemsData')}}" method="POST">
      @csrf
      <div class="card-body">
        ...
        <div style="border-bottom:red" class="form-group row">
          ...
          <div class="col-sm-3">
            ...
            <input type="search" autocomplete="off" class="form-control" name="searchKey" onkeyup="searchCustomer();" id="searchKey" placeholder="Enter Customer Name">
          ...
          <div class="col-sm-3">
            ...
            <input type="text" autocomplete="off" class="form-control" id="customerAddress" placeholder=" Enter Customer Address">

          </div>
          <label for="status" class="col-sm-1 col-form-label">Contact </label>
          <div class="col-sm-3"> <input type="text" autocomplete="off" class="form-control" id="customerContact" placeholder="Enter Customer Contact Number">
          </div>
        </div>
            ...
            <div class="card-header">
              <div class="form-group row">
                ...
                <form>
                  ...
                  <label for="status" class="col-sm-1 col-form-label">Service</label>
                  <div class="col-sm-3">
                    <input type="hidden" class="form-control" name="service_id" id="service_id">
                    <input type="text" autocomplete="off" class="form-control" name="searchKeyForService" onkeyup="searchService();" id="searchKeyForService" placeholder="Enter Service Name">
                  ...
                  <div class="col-sm-2">
                    ...
                    <input type="text" autocomplete="off" class="form-control" id="service_rate" placeholder=" Enter Service Rate">
                  </div>
                  <div class="col-sm">
      ...
      <div class="card-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-3">
            <input type="text" readonly id="total" autocomplete="off" class="form-control" >
          </div>
          <label for="status" class="col-sm-1 col-form-label">Discount</label>
          <div class="col-sm-3">
            <input type="text" id="discount" onkeyup="calculate();" autocomplete="off" class="form-control" placeholder=" Enter Discount">
          </div>
          <label for="status" class="col-sm-1 col-form-label">All Total</label>
          <div class="col-sm-3">
            <input type="text" autocomplete="off" id="alltotal" readonly="true" class="form-control">
          </div>
        </div>
      </div>
...
<script type="text/javascript">
  ...
  function displayBasketItemIntoTable() {
    ...
    for (let i = 0; i < items.length; i++) {
      ...
      var str = '<tr><th>' + items[i].split("{#}")[0] + '</th><th>' + items[i].split("{#}")[2] + '</th><th>' + items[i].split("{#}")[3] + '</td><td onclick="removeItem(\'' + items[i] + '\')"> <i class="fas fa-remove"></i></td></tr>';
