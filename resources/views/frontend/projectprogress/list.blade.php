            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $projectactivity->amount }} </td>
                 
                 

                  <td>
                    <a style="width:40px" href="{{url('projectestimation-edit/' . $projectactivity->tCode)}}" class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a>
