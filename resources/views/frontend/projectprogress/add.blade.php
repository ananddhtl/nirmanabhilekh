        ...
        <form action="{{route('postProjectProgressData')}}" method="POST">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-1">
                        <label style="opacity: 0!important;" for="exampleInputEmail1">Project</label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-1">
                        <input type="number" class="form-control" name="credit" id="credit"
                            onkeyup="changeDebitCredit('credit');" placeholder="Qty ">
                    </div>
...
function displayBasketItemIntoTable() {
    ...
    for (let i = 0; i < items.length; i++) {
        ...
        var str = '<tr><td>' + items[i].split("{#}")[0] + '</td><td>' + items[i].split("{#}")[5] + '</td><td>' + items[
