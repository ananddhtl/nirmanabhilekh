      ...
      <div class="card-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-3">
            ...
            <input type="text" class="form-control " autocomplete="off" name="staff_name" id="staff_name" placeholder="Enter Full Name" required>

          </div>
          <label for="customer_address" class="col-sm-2 col-form-label"> Address</label>
          <div class="col-sm-3">
            <input type="text" class="form-control" autocomplete="off" name="staff_address" id="staff_address" placeholder="Enter Address" required>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-3">
            <input type="email" class="form-control" autocomplete="off" name="staff_email" id="staff_email" placeholder="Enter Email">
          </div>
          <label for="customer_phonenumber" class="col-sm-2 col-form-label">Contact No.</label>
          <div class="col-sm-3">
            <input type="number" class="form-control" autocomplete="off" name="staff_phonenumber" id="staff_phonenumber" placeholder="Enter Contact Number" required>
          </div>
        </div>
        
        <div class="form-group row">
          <label for="customer_position" class="col-sm-2 col-form-label">Position</label>
          <div class="col-sm-3">
            <input type="text" class="form-control" autocomplete="off" name="staff_position" id="staff_position" placeholder="Enter  Position" required>
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-3">
            <input type="text" class="form-control" autocomplete="off" name="staff_profession" id="staff_profession" placeholder=" Enter Customer Profession">
          </div>
        </div>
      </div>
