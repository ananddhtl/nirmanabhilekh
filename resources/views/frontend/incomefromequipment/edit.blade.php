...
<div class="col-md-6">
  ...
  <div class="card card-info">
    <div class="card-header">
      <h3 class="card-title">Update equipment income </h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    @if($errors->any())
    ...
    @endif
    <form action="{{url('update-fromincomeequipment' ,$data[0]->id)}}" method="POST">
      @csrf
      <div class="card-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            ...
            <input type="text" class="form-control" autocomplete="off" name="searchKey" value="{{$data[0]->customer_name}}" onkeyup="searchCustomer();" id="searchKey" placeholder="Enter Customer Name" required>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            ...
            <input type="text" class="form-control" autocomplete="off" name="EquipmentName" onkeyup="searchEquipment();" id="EquipmentName" value="{{$data[0]->equipment_name}}" placeholder="Enter Equipment Name" required>
