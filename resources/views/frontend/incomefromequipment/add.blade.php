...
<div class="col-md-6">
  ...
  <div class="card card-info">
    <div class="card-header">
      <h3 class="card-title">Add equipment income </h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    @if($errors->any())
    ...
    @endif
    <form action="{{route('addincomeequipment')}}" method="POST">
      @csrf
      <div class="card-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            ...
            <input type="text" class="form-control" autocomplete="off" name="searchKey" onkeyup="searchCustomer();" id="searchKey" placeholder="Enter Customer Name" required>
