...
<body>
    <section class="main-pd-wrapper" style="width: 950px; margin: auto; margin-top:50px;">
        ...
        <div class="body-section">
            <h3 class="heading">Expenses from Equipment </h3>
            <br>
        ...
        <table style="width: 100%;
            ...
            <thead>
                ...
                <button id="printPageButton" style="height:30px;width:130px;font-size:15px;" onclick="window.print()">Print This Page</button>
            </thead>
