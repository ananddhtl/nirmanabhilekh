...
<section class="content-header">
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-6 ">
                        ...
                        <form action="{{url('/equipmentcatagorysearch')}}" method="GET" accept-charset="utf-8">
                            @csrf
                            <div style="margin-bottom:15px; " class="input-group">
                                <input type="text" autocomplete="off" name="equipment_catagories_name" class="form-control form-control-lg" placeholder="Enter equipment catagory name">
                ...
                <table class="table table-bordered" id="mytable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a style="width:40px" href="{{url('edit-equipmentcatagory/' .$item->id)}}" class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a>&nbsp;
        ...
        <div class="card-footer clearfix">
            ...
            <ul class="pagination pagination-sm m-0 float-right">
                <div class="row">
                    ...
                    <a href="{{url('equipmentcatagory-export')}}">
    ...
    <script>
        function showModal(id) {
            document.getElementById("deleteItem").href = "/delete-equipmentcatagory/" + id;
