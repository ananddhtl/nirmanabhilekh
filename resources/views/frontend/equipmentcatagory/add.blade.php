            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control " autocomplete="off" name="equipment_catagories_name" id="equipment_catagories_name" placeholder="Enter equipment category name" required>
